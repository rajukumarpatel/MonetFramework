...
public class NegativeTestCaseofUploadContent extends RootTest
{
 AppFunc ap=new AppFunc(gf);
 @Test
 
 public void NegativeTestcaseofUploadContent() throws FileNotFoundException, IOException, AWTException
 {
	 ...
	 gf.sleep(3000);
	 ap.NegativeTestCaseofUploadContent();
	 gf.sleep(3000); 
	 gf.closeBrowser();		
